...
export default function NewPurchaseVoucher() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(
        "http://localhost:5000/purchase-voucher",
        {
          supplierId,
          voucherNumber,
          date,
      ...
      router.push("/transactions/purchase-voucher");
    } catch (err) {
      setError(
        err.response?.data?.message || "Failed to create purchase voucher"
      );
    }
  };
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-8">
      ...
      >
        <h1 className="text-xl font-bold mb-4">New Purchase Voucher</h1>
